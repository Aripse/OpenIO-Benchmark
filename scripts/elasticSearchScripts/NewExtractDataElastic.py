...
def extract_save_file(save_path, client):
    # To specifie the index of the .gz files we want to extract
    parser.add_argument("index", type=str, help="Where will found the .gz files")
...
if __name__ == "__main__":
    ...
    extract_save_file("/Users/brice21/Desktop/OpenIO/filesExtract", client)
